...
public class ContactDAOImpl extends BaseDAO implements ContactDAO {
    ...
    public void save(Contact c) {
        String sql = "INSERT INTO contact(userId, name, phone, email, adress, remark) VALUES(:userId, :name, :phone, :email, :adress, :remark)";
        Map m = new HashMap();
    ...
    public void update(Contact c) {
        String sql = "UPDATE contact SET name=:name, phone=:phone, email=:email, adress=:adress, remark=:remark WHERE contactId=:contactId";
        Map m = new HashMap();
    ...
    public List<Contact> findAll() {
        String sql = "SELECT contactId, userId, name, phone, email, adress, remark FROM contact";
