...
public class UserDAOImpl extends BaseDAO implements UserDAO {
    ...
    public void save(User u) {
        String sql = "INSERT INTO user(name, phone, email, adress, loginName, password, role, loginStatus)"
                + " VALUES(:name, :phone, :email, :adress, :loginName, :password, :role, :loginStatus)";
        Map m = new HashMap();
